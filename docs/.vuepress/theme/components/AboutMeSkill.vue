...
const technology = ref([
  ...
  { type: 'TypeScript', icon: 'skill-icons:typescript' },
  { type: 'Python', icon: 'skill-icons:python-light' },
  { type: 'Golang', icon: 'skill-icons:golang' },
]);

// 工具
const tools = ref([
  { type: 'VSCode', icon: 'vscode-icons:file-type-vscode' },
  { type: 'Nvim', icon: 'skill-icons:neovim-light' },
  { type: 'IDEA', icon: 'logos:intellij-idea' },
  { type: 'AE', icon: 'skill-icons:aftereffects' },
  { type: 'PR', icon: 'skill-icons:premiere' },
  { type: 'PS', icon: 'skill-icons:photoshop' },
  { type: 'Blender', icon: 'skill-icons:blender-light' },
  // { type: 'Kitty', icon: ''}
]);
</script>
