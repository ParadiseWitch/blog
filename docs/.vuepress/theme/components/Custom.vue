<template>
  <div class="container">
    ...
    <div class="head-social">
      <a href="https://github.com/ParadiseWitch" target="_blank" class="head-social-btn1">
        <icon class="head-social-btn" name="mingcute:github-fill" />
      </a>
      <a href="https://space.bilibili.com/155924629" target="_blank" class="head-social-btn2">
        <icon class="head-social-btn" name="mingcute:bilibili-fill" />
      </a>
      <router-link to="/blog/" class="head-social-avatar"><img src="/avatar.png" alt="avatar"></router-link>
      <a href="https://x.com/maiiiiiiiiiid" target="_blank" class="head-social-btn2">
        <icon class="head-social-btn" name="mingcute:twitter-fill"></icon>
      </a>
      <a href="https://t.me/Maiiiiiiiid" target="_blank" class="head-social-btn1">
        <icon class="head-social-btn" name="mingcute:telegram-fill"></icon>
      </a>
    </div>
    <div class="about-me">
        ...
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              ...
              <p class="about-me-card-text-big">Never</p>
              <p class="about-me-card-text-big about-me-card-text-color">Never say never</p>
            </slot>
          </template>
        </AboutMeText>
      </div>
...
.head-social {
  ...
  .head-social-avatar {
    ...
    &:hover {
      ...
      /* 轻微上浮效果替代缩放 */
      box-shadow: 0 5px 10px var(--avatartar-shadow-color, rgba(0, 0, 0, 0.1));
      /* 悬停时阴影扩散 */
    }
  }
